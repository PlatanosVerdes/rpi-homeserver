...
#
# Same idea as install-crontab.sh: the thing that keeps the Pi's logs bounded should come back
...
#
# Called from apply.sh. To run by hand: bash scripts/install-logrotate.sh
