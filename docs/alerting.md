...
| `since 00:41` | `.StartsAt`, in the Pi's timezone. The Grafana service is given `TZ` for this: without it Go formats in UTC and every alert reads two hours early |
